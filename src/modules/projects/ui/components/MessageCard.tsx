    ...
    return (
        <div className={cn(
            ...
            <div className="flex items-center gap-2 pl-2 mb-2">
               <Image src="/logo.jpg" alt="brix" width={30} height={30} className="shrink-0 rounded-full"></Image>
            ...
            <div className="pl-8.5 flex flex-col gap-y-4">
                ...
                {fragment && type === "RESULT" && (
                    <FragmentCard fragment = {fragment} isActiveFragment= {isActiveFragment} onFragmentClick = {onFragmentClick}></FragmentCard>
                )}
            </div>
        </div>
    )
